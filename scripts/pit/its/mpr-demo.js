...
(async () => {
    ...
    await takeScreenshot(page, arg, __filename, 'notification-dismissed');

    log('Testing Spreadsheet view');
    await page.getByRole('link', { name: 'Spreadsheet' }).click();
    await page.waitForURL(`${arg.url}spreadsheet`);
    await takeScreenshot(page, arg, __filename, 'spreadsheet-loaded');
    ...
    await takeScreenshot(page, arg, __filename, 'legacy-tested');
    ...
    await takeScreenshot(page, arg, __filename, 'back-to-home');
