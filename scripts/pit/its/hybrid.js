...
(async () => {
    ...
    await takeScreenshot(page, arg, __filename, 'flow-person-selected');
    
    await page.locator('input[type="text"]').nth(0).fill('FOO');
    await takeScreenshot(page, arg, __filename, 'flow-input-filled');
    
    await page.locator('text=Save').click();
    await takeScreenshot(page, arg, __filename, 'flow-save-clicked');
    
    await page.locator('text=/Updated/');
    await takeScreenshot(page, arg, __filename, 'flow-update-confirmed');
    ...
    await page.locator('text=eula.lane').click();
    await takeScreenshot(page, arg, __filename, 'hilla-person-selected');
    
    await page.locator('input[type="text"]').nth(0).fill('FOO');
    await takeScreenshot(page, arg, __filename, 'hilla-input-filled');
    
    await page.locator('text=Save').click();
    await takeScreenshot(page, arg, __filename, 'hilla-save-clicked');
    
    await page.locator('text=/Stored/');
    await takeScreenshot(page, arg, __filename, 'hilla-stored-confirmed');
